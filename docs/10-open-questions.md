...
| Q25 | **What is the Red Pitaya's AC-coupling corner, and what is the noise floor AC-coupled?** The detector's 0–10 V unipolar output has to be AC coupled to use the ±1 V range, but **every noise figure in `05-results.md` was measured DC-coupled**, and the corner frequency is not recorded anywhere. 991.821 kHz should be far above any sensible corner, but "should be" is what this project keeps getting caught by. Cheap to settle in loopback: AC-couple and repeat H3.3. Raised 2026-08-14. |
